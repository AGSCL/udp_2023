...
# Archivos .csv 
read.csv("bbdd_prueba1.csv",header = TRUE, sep = ";")
# header especifica que el nombre de la variable va en la primera fila 
# sep establece la separacion, en este caso usamos punto y coma.
